...
**_ВНИМАНИЕ!!! Для предотвращения противодействия со стороны HH исходный код актуальной версии расширения скрыт. В открытом github код предыдущей версии.
Работоспособность кода в данном репозитории не гарантирована!
