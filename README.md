...
**ВНИМАНИЕ!!! Исходный код расширения с 13.11.2024г. закрыт по соображениямм безопасности**
В данном репозиитории содержатся инструкции по установке и описание функционала расшиирения.

![Иконка расширения 128px](./img/icon-128.png)
...
Проще всего установить его можно из [офицального источника расширений для браузера chrome](https://chromewebstore.google.com/detail/hhru-resumes-updater/).
